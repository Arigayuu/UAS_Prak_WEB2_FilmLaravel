    ...
    <div class="container">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">
                Buat kategori baru untuk mengorganisir koleksi film Anda dengan lebih baik
            </p>
        </div>
    </div>
</div>
        ...
        <form action="{{ route('categories.store') }}" method="POST" id="categoryForm">
            ...
            <div class="form-section">
                ...
                <div class="category-preview" id="categoryPreview">
                    ...
                    <span class="preview-tag" id="previewTag">Nama Kategori</span>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    nameInput.addEventListener('input', function() {
        this.classList.remove('is-invalid');
        const feedback = this.parentNode.querySelector('.invalid-feedback');
        if (feedback && !feedback.textContent.includes('Nama kategori minimal 2 karakter')) {
            feedback.remove();
        }
    });
});
